//
// Created by Patrick on 11.02.2019.
//
...
long testSort(std::vector<int> test, int size, bool stdSort){
    std::vector<int> copy;
    if(!stdSort){
        copy = test;
    ...
    std::cout << "Anzahl an Vergleichen:" << std::endl << std::endl;
    std::cout << "Anzahl an Zuweisungen:" << std::endl << std::endl;
    ...
    std::cout << "Vergleiche durch n*log2(n):" << std::endl << std::endl;
    std::cout << "Zuweisungen durch n*log2(n):" << std::endl << std::endl;
    ...
    if(!stdSort){
        ...
        for(auto sortIt = copy.begin(); sortIt != copy.end(); sortIt++){
            if(*sortIt != *testIt){
                ...
                std::cout << "Wert: " << *testIt << std::endl;
                std::cout << "erwartet: " << *sortIt << std::endl;
                success = false;
            }
            testIt++;
        }
