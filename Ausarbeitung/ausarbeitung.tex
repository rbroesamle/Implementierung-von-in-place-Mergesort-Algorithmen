...
\textbf{Big Type with expensive comparison Diagram} \\
...
\textbf{Comparisons with another normalisation} \\
...
\textbf{Time different iterations} \\
...
\textbf{Comparisons/Assignments different iterations and merges} \\
...
\textbf{Comparisons different iteration and smallsorts} \\
...
\textbf{Time different iteration and smallsorts} \\
...
\textbf{Time comparisons with other inplace merge sorts} \\
